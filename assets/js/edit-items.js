...
function editItem(id, restaurantId) {
    ...
    setTimeout(() => {
        window.location.href = '../views/edit-item.php?id='+id+'&restaurantId='+restaurantId;
    }, 300);
}
...
function updateFoodStatus(foodId) {
    ...
    var http = new XMLHttpRequest();
    var url = '../requests/update-food-status.php';
    var params = 
    'foodId='+foodId
    ;
