...
if (isset($_GET['id']) && $_GET['id'] != '') {
    ...
    $food_price = $row_select_food['price'];
    $food_tmp_price = $row_select_food['tmp_price'];
    ...
    <div class="edit-item-form">
        <div id="edit-item-form">
            <div class="pb-10">            
                ...
                <?php
                $sql_select_category = 'SELECT * FROM category WHERE restaurant_id = "'.$_GET["restaurantId"].'" ORDER BY category_name ASC';
                ...
                <div class="input-group">
                    <div class="input-control-group">
                        <input type="tel" value="<?php echo $food_tmp_price; ?>" readonly>
                    </div>
                </div>
