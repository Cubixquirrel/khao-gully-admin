...
<body>
    ...
    <div class="edit-items-menu">
        ...
        if (isset($_GET['restaurantId']) && $_GET['restaurantId'] != '') {
            $sql_select_food = 'SELECT * FROM food WHERE restaurant_id = "'.$_GET["restaurantId"].'" ORDER BY id DESC';
        } else {
            $sql_select_food = 'SELECT * FROM food ORDER BY id DESC';
        }
                ...
                <div class="menu-first">
                    <div class="edit-items-menu-list">
                        ...
                        <div class="edit-items-action">
                            ...
                            <div>
                                <span onclick="editItem('<?php echo $row_select_food['id']; ?>', '<?php echo $row_select_food['restaurant_id']; ?>')">Edit</span>
                            ...
                            <?php
                                if ($row_select_food['food_status'] == 'true') {
                                    ?>
                                    <div>
                                        <span class="update-status-button active">Approved</span>
                                    </div>
                                    <?php
                                } else {
                                    ?>
                                    <div>
                                        <span class="update-status-button" onclick="updateFoodStatus('<?php echo $row_select_food['id']; ?>')">Approve</span>
                                    </div>
                                    <?php
                                }
                            ?>
